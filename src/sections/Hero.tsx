...
export function Hero() {
  return (
    <section className="hero" aria-labelledby="hero-title">
      ...
      <p className="hero__lede reveal" style={{ '--delay': '260ms' } as React.CSSProperties}>
        {profile.positioning}
      </p>
      <div className="hero__actions reveal" style={{ '--delay': '400ms' } as React.CSSProperties}>
      ...
      <a className="hero__scroll reveal" href="#work" style={{ '--delay': '700ms' } as React.CSSProperties}>
